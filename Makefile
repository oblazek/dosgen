...
# Library
libdos.a: trafgen_wrapper.o libtcpgen.a
	ar rcs -o $@ $^
...
libtcpgen.a:
	(cd tcpgen; $(CC) $(CFLAGS) -c tcpgen.c handshake.c checksum.c; ar rcs -o libtcpgen.a tcpgen.o handshake.o checksum.o; cp libtcpgen.a ../)
